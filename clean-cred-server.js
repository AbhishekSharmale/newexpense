...
server.listen(1010, () => {
  console.log('🚀 Clean ExpenseAI CRED Experience on http://localhost:1010')
  console.log('🎨 Beautiful UI with charts + Real ICICI processing')
  console.log('✨ No intelligence features - just core functionality')
})